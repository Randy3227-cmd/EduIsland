...
CREATE TABLE public.matieres (
  ...
  CONSTRAINT matieres_ville_id_fkey FOREIGN KEY (ville_id) REFERENCES public.villes(id)
);
CREATE TABLE public.niveau_types (
...
CREATE TABLE public.niveaux (
  ...
  CONSTRAINT niveaux_matiere_id_fkey FOREIGN KEY (matiere_id) REFERENCES public.matieres(id),
  CONSTRAINT niveaux_type_id_fkey FOREIGN KEY (type_id) REFERENCES public.niveau_types(id)
);
CREATE TABLE public.scores (
  ...
  CONSTRAINT scores_niveau_id_fkey FOREIGN KEY (niveau_id) REFERENCES public.niveaux(id)
);
